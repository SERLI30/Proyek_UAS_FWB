  ...
  <header id="header" class="header d-flex align-items-center position-relative">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <img src="{{ asset("utama") }}/assets/img/Vintages.png" alt="VintageMuse" style="width: 100%; height: 500px">
        <h2 class="sitename">VintageMuse</h2>
      </a>
    ...
    @auth
        @php
            ...
            $dashboardLink = '#';
            if ($user->role === 'admin') {
                $dashboardLink = route('admin.dashboard_admin');
            } elseif ($user->role === 'seller') {
                $dashboardLink = route('produkPenjual.dashboard_penjual');
            } elseif ($user->role === 'customer') {
                $dashboardLink = route('pembeli.dashboard_pembeli');
            }
        @endphp
...
@endif
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="{{ asset("utama") }}/assets/img/wanita/wanita_laki.jpeg" alt="">
          <div class="carousel-container">
            <h2>Love, Style, and Elegance</h2>
            <p>Discover beauty in every step — with the one you love, in timeless fashion and graceful elegance.</p>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="{{ asset("utama") }}/assets/img/aksesoris/kalung1.jpeg" alt="Kalung">
          <div class="carousel-container">
            <h2>Timeless Beauty in Every Pear</h2>
            <p>Embrace the charm of a pearl necklace that captures eternal elegance and refined luxury — made to shine through every moment.</p>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="{{ asset("utama") }}/assets/img/aksesoris/sisir.jpeg" alt="">
          <div class="carousel-container">
           <h2>Radiating Elegance in Every Detail</h2>
            <p>A refined collection of accessories that add charm and beauty to every special moment.</p>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="{{ asset("utama") }}/assets/img/wanita/gauncoklat.jpeg" alt="Fairy Gaun" style="width: 100%; height: auto;">
          <div class="carousel-container">
            <h2>A Dress That Defines Elegance</h2>
            <p>Let your style shine with a gown that blends beauty, confidence, and timeless charm.</p>
          </div>
        </div><!-- End Carousel Item -->

        <div class="carousel-item">
          <img src="{{ asset("utama") }}/assets/img/pria/jas_coklat.jpeg" alt="">
          <div class="carousel-container">
            <h2>Tailored to Impress</h2>
            <p>A classic suit for the modern gentleman — confidence, elegance, and timeless style in every stitch.</p>
          </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
              <img src="{{ asset("utama") }}/assets/img/wanita/wanitalaki2.jpeg" alt="Image " class="img-fluid img-overlap" data-aos="zoom-out">
            </div>
            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="opacity-50">
                Kami percaya bahwa setiap produk bukan hanya sekadar barang, melainkan karya seni yang memiliki cerita 
                dan keanggunan tersendiri. Setiap koleksi kami dipilih dengan teliti untuk menghadirkan nuansa klasik 
                yang abadi. Kami menjunjung tinggi kualitas, estetika, dan nilai keberlanjutan. Dengan desain yang elegan
                 dan pelayanan yang hangat, kami hadir untuk memberi pengalaman berbelanja yang istimewa dan penuh makna.
              </p>
    ...
    <section id="services-2" class="services-2 section dark-background">
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Vintage Touches, Modern Elegance</h2>
        <p>We bring delicate artistry into every piece — designed to complete your look with beauty, charm, and sophistication.</p>
  ...
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We style</span>
        <h2 class="service-item-title">Outfits</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/pria/celana.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We elevate</span>
        <h2 class="service-item-title">Dresses</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/wanita/gauncream2.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We match</span>
        <h2 class="service-item-title">Accessories</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/aksesoris/kalung2.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We define</span>
        <h2 class="service-item-title">Timeless Looks</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/aksesoris/jam1.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We pick</span>
        <h2 class="service-item-title">Footwear</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/aksesoris/sepatu.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We tailor</span>
        <h2 class="service-item-title">Formalwear</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/pria/jaskotak.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
</div>
...
<div class="swiper-slide">
  <div class="service-item">
    <div class="service-item-contents">
      <a href="#">
        <span class="service-item-category">We create</span>
        <h2 class="service-item-title">Elegance</h2>
      </a>
    </div>
    <img src="{{ asset('utama') }}/assets/img/wanita/gauncream2.jpeg" alt="Image" style="width: 100%; height: 350px; object-fit: cover; object-position: center;">
  </div>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">VintageMuse</span>
            </a>
            <div class="footer-contact pt-3">
              <p>Serli</p>
              <p>Indonesia, Majene</p>
              <p class="mt-3"><strong>Phone:</strong> <span>+6238274842</span></p>
              <p><strong>Email:</strong> <span>serli@gmail.com</span></p>
            </div>
          </div>
